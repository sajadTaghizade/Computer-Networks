...
int main(int argc, char *argv[]) {
    ...
    WifiMacHelper mac;
    Ssid ssid = Ssid("wifi6-advanced-network");
    ...
    apPosition->Add(Vector(0.0, 0.0, 3.0));
    ...
    std::cout << "Starting Phase 4 (Advanced) Simulation for " << simTime << " seconds...\n" << std::endl;
    ...
    for (auto i = stats.begin(); i != stats.end(); ++i) {
        ...
        if (t.destinationPort == port) {
            ...
            totalThroughput += i->second.rxBytes * 8.0 / simTime / 1024 / 1024; 
    ...
    monitor->SerializeToXmlFile("phase4-flowmon.xml", true, true);
    Simulator::Destroy();
    return 0;
}